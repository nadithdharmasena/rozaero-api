...
SpotifyWebApi.prototype = {
  ...
  getPlaylistsForCategory: function(categoryId, options, callback) {
    ...
    rozaero_refreshToken: function(refresh_token, callback) {

        var credentials = require('../../../helpers/spotify_ops').credentials;
    ...
    rozaero_getCurrentlyPlayingTrack: function(options, access_token, callback) {
    ...
    rozaero_play: function(options, access_token, callback) {
        /*jshint camelcase: false */
        var _options = options || {};
        var queryParams = _options.device_id
            ? { device_id: _options.device_id }
    ...
    rozaero_getUserPlaylists: function(userId, access_token, options, callback) {
        var path;
        if (typeof userId === 'string') {
            path = '/v1/users/' + encodeURIComponent(userId) + '/playlists';
        } else {
    ...
    rozaero_getPlaylistTracks: function(userId, playlistId, access_token, options, callback) {
        return WebApiRequest.builder(access_token)
            .withPath(
                '/v1/users/' +
                encodeURIComponent(userId) +
    ...
    rozaero_search: function(query, types, options, access_token, callback) {
        return WebApiRequest.builder(access_token)
            .withPath('/v1/search/')
            .withQueryParameters(
                {
